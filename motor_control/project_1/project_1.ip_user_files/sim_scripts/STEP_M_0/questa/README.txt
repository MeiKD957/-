...
#
# Generated by export_simulation on Fri Jul 31 17:56:31 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './STEP_M_0.sh' script.

./STEP_M_0.sh -reset_run
...
./STEP_M_0.sh -noclean_files

For more information on the script, please type './STEP_M_0.sh -help'.
